...
class ModuleAdminController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, CourseRepository $courseRepository, \App\Service\FileUploader $fileUploader): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // If courses were selected, we could redirect to one of them, but safer to go to general list
    ...
    public function edit(Request $request, Module $module, EntityManagerInterface $entityManager, \App\Service\FileUploader $fileUploader): Response
    {
